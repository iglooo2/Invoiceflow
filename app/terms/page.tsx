    ...
    <div>
      ...
      <main className="prose mx-auto w-full max-w-3xl px-4 py-16">
        ...
        <div className="mt-8 grid gap-4 text-sm leading-7">
          <p>InvoiceFlow Studio (invoiceflowstudio.com) is a tool for creating, sending, and tracking invoices and proposals. It is not a bank, accountant, tax advisor, or payment processor for your client invoices in this MVP.</p>
